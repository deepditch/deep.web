...
export class ExpandedDamageWindow extends Component {
  ...
  _verify() {
    this.props.verifyDamageReport(
      this.props.damage.image.reports,
      this.state.damagesInImage
    );
    this._closeEdit();
  }
            ...
            <div class="block-medium">
              ...
              {this.state.editOpen ? (
                ...
                <div class="row narrow-gutters">
                  ...
                  <div class="col-auto">
                    {this.props.damage.image.reports.filter(
                      report =>
                        report.verified == true || report.false_positive == true
                    ).length != this.props.damage.image.reports.length && (
                      <button
                        class="btn btn-small bg-green link verify"
                        onClick={this._verify}
                      >
